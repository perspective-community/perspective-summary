...
var SYNC_MODULE = await fs.readFile(path.join(__dirname, "../../dist/wasm/perspective-server.wasm")).then((buffer) => load_wasm_stage_0(buffer.buffer)).then((buffer) => compile_perspective(buffer.buffer));
var SYNC_CLIENT;
